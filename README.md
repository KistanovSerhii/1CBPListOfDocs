...
Выполните все как для типового, а пункт 4 (работа с формой списка) замени на это действие:
Добавьте в модуль формы код (на забудьте связать событие формы "ПриСозданииНаСервере"):
 ```
